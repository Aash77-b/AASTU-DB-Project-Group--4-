...
We would like to thank the following individuals for their valuable contributions to this database assignment project. Each team member brought unique expertise and commitment, making this project a success.
...
|------|------|------------------|
| **Dagmawit Biniyam** | Business Analyst | Requirement gathering, defining business rules, translating needs into database specifications, and ensuring alignment with project goals. |
...
This assignment was completed as part of a collaborative database systems course. Each member contributed equally and consistently. Special thanks to our instructor for guidance and to the open-source community for tools that made our work easier.
